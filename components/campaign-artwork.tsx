...
function ArtworkFallback({ locale = 'en',
  campaignName,
  compact,
  state,
  store,
      ...
      <div className="relative flex h-full flex-col justify-between p-4 sm:p-5">
        ...
        <div className="flex items-center gap-2 text-[0.6rem] font-bold uppercase tracking-[0.18em] text-white/55">
          <span
            ...
            aria-hidden="true"
          />
          {t(locale, "Official sale campaign")}
        </div>
      </div>
    </div>
  )
...
export function CampaignArtwork({ locale = 'en',
  artworkUrl,
  campaignName,
  compact,
  state,
  ...
  return (
    <div className="relative aspect-video overflow-hidden bg-[#111]">
      ...
      <img
        src={artworkUrl}
        alt={t(locale, "{value0} official campaign artwork", { value0: campaignName })}
        loading="lazy"
        decoding="async"
