...
const platformHeroTreatments = {
  ...
  pc: {
    ...
    logo: {
      ...
      width: 744,
      height: 171,
      className: 'h-auto w-36 opacity-75 sm:w-44 lg:w-52',
    },
  },
  nintendo: {
...
} as const satisfies Record<Platform, object>
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 pl-12 sm:pl-16">
          {platform === 'pc' ? (
            <span className="text-6xl font-black tracking-[-0.07em] text-white/90 sm:text-7xl lg:text-8xl">
              PC
            </span>
          ) : null}
          <Image
